...
```
\  
Heart disease patients are mostly distributed in elderly groups over the age 50.From individuals with the age smaller than 50, heart disease is a rarely seen prevalence with a rate lower then 5%. In each age group over 50 while smaller than 75, the rate of heart disease is about 10% to 16%. In elder age groups, the rate of heart disease is about 20%, accounting for one-fifth of the population.
\  
